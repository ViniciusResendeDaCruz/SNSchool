...
<div>
	<h2 class="p-3 text-center">O que você deseja fazer hoje Gestor?</h2>

	<div class="container dash mb-5">
		<div class="row">
			<div class="col-md-4">
		...
		<div class="row mt-3">
			...
			<div class="col-md-6">
				<a href="<?php echo base_url('cadastro') ?>" class="nolink">
					<section class="gradient-custom text-center border rounded shadow-lg highlight-blue" style="padding-top: 50px;"><svg class="bi bi-paperclip" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" style="transform: scale(4.62);">
							<path d="M4.5 3a2.5 2.5 0 0 1 5 0v9a1.5 1.5 0 0 1-3 0V5a.5.5 0 0 1 1 0v7a.5.5 0 0 0 1 0V3a1.5 1.5 0 1 0-3 0v9a2.5 2.5 0 0 0 5 0V5a.5.5 0 0 1 1 0v7a3.5 3.5 0 1 1-7 0V3z"></path>
						</svg>
						<div class="container">
						...
						<h1>Novo Usuário</h1><small>Adicione um usuário</small>
					</section>
				</a>
			</div>
			<div class="col-md-6">
				<a href="<?php echo base_url('dados') ?>" class="nolink">
					<section class="gradient-custom text-center border rounded shadow-lg highlight-blue" style="padding-top: 50px;">
						<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style="transform: scale(4.62);">
						...
						<h1>Dados</h1><small>Veja os dados dos usuários</small>
					</section>
				</a>
			</div>
		</div>
