...
<style>
	...
	.table {
		...
		--bs-table-striped-bg: rgba(19, 55, 216, 0.25);
		--bs-table-active-color: #858796;
		--bs-table-active-bg: rgba(0, 0, 0, 0.1);
		--bs-table-hover-color: #858796;
		--bs-table-hover-bg: rgba(0, 0, 0, 1);
		width: 100%;
		/* margin-bottom: 1rem; */
		...
		<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 gradient-custom sticky-top">
			<div class="container-fluid d-flex flex-column p-0 sticky-top"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
				...
				<ul class="navbar-nav text-light" id="accordionSidebar">
					...
					<li class="nav-item"><a class="nav-link" href="<?php echo base_url('dashboard') ?>"><i class="far fa-clipboard"></i><span>Dashboard</span></a></li>
					<li class="nav-item"><a class="nav-link" href="<?php echo base_url('perfil') ?>"><i class="fas fa-user"></i><span>Meu Perfil</span></a></li>
					<li class="nav-item"><a class="nav-link" href="<?php echo base_url('disciplinas') ?>"><i class="fas fa-table"></i><span>Disciplinas</span></a></li>

					<li class="nav-item"><a class="nav-link" href="<?php echo base_url('Cadastro') ?>"><i class="far fa-clipboard"></i><span>Novo usuário</span></a></li>
					<li class="nav-item"><a class="nav-link" href="<?php echo base_url('dados') ?>"><i class="bi bi-pie-chart"></i><span>Dados</span></a></li>
					<li class="nav-item"><a class="nav-link" href="<?php echo base_url('relatorios') ?>"><i class="bi bi-paperclip" style="font-size: 15px;"></i><span>Relatórios</span></a></li>
