...
<h2 class="p-3 text-center">Altere aqui o seu perfil, aluno</h2>
    ...
    <div class="card shadow mb-3">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="mb-3"><label class="form-label" for="senha"><strong>Senha</strong></label><input id="senha" class="form-control" type="password" placeholder="Insira a nova senha" name="senha" /><p class="fs-6 fst-italic">*deixe em branco caso não queira alterar</p></div>
                </div>
                <div class="col">
                    <div class="mb-3"><label class="form-label" for="repete_senha"><strong>Repita a senha</strong></label><input id="repete_enha" class="form-control" type="password" placeholder="Repita a nova senha" name="repete_senha" /></div>
                </div>
            </div>
            <div class="row">
                <div class="col">
